...
export default function Home(props) {
  ...
  const { valueMake, setValueMake, inputValueMake, setInputValueMake, valueModel, setValueModel, inputValueModel, setInputValueModel, valueYear, setValueYear, inputValueYear, setInputValueYear, valueVersion, setValueVersion, inputValueVersion, setInputValueVersion, models, years, versions, clearRoleMake, clearRoleModel, clearRoleYear } = useFilter()
  ...
  return (
    <main className="font-medium text-gray-700 bg-white">
      ...
      <header className="flex justify-between max-w-screen-xl px-6 py-4 mx-auto lg:px-8 xl:px-4 lg:py-6">
        <Link href="/">
          <a>
            <img className="mr-auto rounded-full h-24 w-24" src="/localizeei.jpg" />
          </a>
        </Link>
      ...
      {/* <!--/ form block --> */}
      <div className="py-12 md:py-24 bg-gray-100 md:py-24">
        <div className="grid max-w-screen-xl px-6 mx-auto lg:px-8 xl:px-4 md:grid-cols-4 xl:grid-cols-5 gap-x-12 lg:gap-x-20">
          <div className="self-center order-2 col-span-2 mt-12 md:order-1 md:mt-0">
            <h1 className="mb-2 text-center text-3xl font-bold text-gray-800 md:text-4xl lg:text-5xl md:mb-4 lg:mb-8">O que você esta procurando?</h1>
            <div className="bg-white border-gray-500 border-r-2 border-b-2 border-l-2 rounded-md py-5 md:max-w-3xl sm:mx-auto">
              {/* <MainFilter /> */}
              ...
              <div className="grid grid-col-1 items-center justify-center gap-4 px-10 py-5 md:max-w-3xl sm:mx-auto">
                <Autocomplete
                  value={valueMake}
                  onChange={(event, newValue: NewValue | null) => {
                    clearRoleMake()
                    if (newValue != null) {
              ...
              <div className="flex items-center justify-center">
                <button onClick={() => getMetadata()} className="bg-yellow-400 text-white font-bold w-4/5 sm:w-36 py-2 rounded-md">Consultar</button>
              </div>
              {/* <MainFilter /> */}
            </div>
          ...
          <div className="order-1 col-span-2 md:order-2 xl:col-span-3">
            <img src="/hmain.png" className="rounded-lg shadow-2xl" alt="" />
          </div>
        </div>
      </div>
      {/* <!--/ form block --> */}
      ...
      <div className="max-w-screen-xl px-6 mx-auto mb-12 lg:px-8 xl:px-4 lg:mb-16 xl:mb-24">
        ...
        <div className="grid items-start md:grid-cols-3 gap-x-8 gap-y-8">
          <div className="p-4 bg-white border-2 border-indigo-100 rounded-lg md:p-8 md:border-white ">
            ...
            <Link href="/pricing">
              <a className="block px-5 py-3 mb-8 font-bold text-center border rounded-lg lg:px-8 bg-gradient-to-br hover:from-indigo-500 hover:to-indigo-700 hover:text-white">Start Now</a>
            </Link>
            <ul className="space-y-4 text-lg text-gray-600">
              ...
              <li className="flex items-center space-x-2 opacity-25">
                <div className="w-6 h-6">
                   
                </div>
          ...
          <div className="p-4 bg-white border-2 border-indigo-100 rounded-lg md:p-8 lg:py-12 md:transform md:-translate-y-10 md:-mb-10 md:shadow-md md:hover:shadow-xl md:transition-all md:duration-500 md:border">
            ...
            <Link href="/pricing">
              <a className="block px-5 py-3 mb-8 font-bold text-center text-white border rounded-lg lg:px-8 bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700">Start Now</a>
            </Link>
            <ul className="space-y-4 text-lg text-gray-600">
              {/* <li className="flex items-center space-x-2">
                <div className="w-6 h-6">
